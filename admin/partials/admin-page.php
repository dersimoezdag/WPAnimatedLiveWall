...
<div class="wrap wpalw-admin-page">
    ...
    <div id="wpalw-admin-tabs" class="wpalw-tabs">
        <ul>
            <li><a href="#tab-walls"><?php echo esc_html__('Manage Walls', 'wp-animated-live-wall'); ?></a></li>
            <li><a href="#tab-settings"><?php echo esc_html__('Global Settings', 'wp-animated-live-wall'); ?></a></li>
        </ul>
            ...
            <form method="post" action="options.php" class="wpalw-settings-form">
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            <input type="number" name="wpalw_global_options[default_rows]"
                                value="<?php echo esc_attr($default_rows); ?>"
                                min="1" max="12" step="1" />
                            <p class="description">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <input type="number" name="wpalw_global_options[default_columns]"
                                value="<?php echo esc_attr($default_columns); ?>"
                                min="1" max="12" step="1" />
                            <p class="description">
