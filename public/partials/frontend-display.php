<div class="wpalw-container" data-wall-id="<?php echo esc_attr($wall_id); ?>">
    <div class="wpalw-grid" data-columns="<?php echo esc_attr($columns); ?>" data-rows="<?php echo esc_attr($rows); ?>">
        ...
        foreach ($images as $image_id) :
            // Break the loop if we've reached the maximum allowed images
            if ($counter >= $total_allowed_images) break;
        ...
        ?>
                <div class="wpalw-grid-item">
                    <div class="wpalw-image-container">
                        <img src="<?php echo esc_url($image_medium[0]); ?>" data-wall-id="<?php echo esc_attr($wall_id); ?>" data-image-id="<?php echo esc_attr($image_id); ?>" alt="<?php echo esc_attr($alt_text); ?>" class="wpalw-image">
                    </div>
                </div>
        <?php
            endif;
