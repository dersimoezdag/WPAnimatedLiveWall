...
<div class="wpalw-container<?php echo (isset($keyvisual_mode) && $keyvisual_mode) ? ' wpalw-keyvisual-container' : ''; ?><?php echo $keyvisual_fullwidth ? ' wpalw-keyvisual-extended' : ''; ?>" id="wpalw-container-<?php echo $wall_id; ?>"> <?php if (isset($keyvisual_mode) && $keyvisual_mode) : ?>
    ...
    <div id="wpalw-<?php echo $wall_id; ?>" class="wp-animated-live-wall" data-rows="<?php echo $rows; ?>" data-rows-sm="<?php echo $rows_sm; ?>" data-rows-md="<?php echo $rows_md; ?>" data-rows-lg="<?php echo $rows_lg; ?>" data-rows-xl="<?php echo $rows_xl; ?>" data-columns="<?php echo $columns; ?>" data-columns-sm="<?php echo $columns_sm; ?>" data-columns-md="<?php echo $columns_md; ?>" data-columns-lg="<?php echo $columns_lg; ?>" data-columns-xl="<?php echo $columns_xl; ?>" data-animation-speed="<?php echo $animation_speed; ?>" data-transition="<?php echo $transition; ?>" data-gap="<?php echo $gap; ?>" data-effects='<?php echo $effects_json; ?>' data-all-image-urls='<?php echo $all_image_urls_json; ?>' data-tiles-at-once="<?php echo $tiles_at_once; ?>" style="grid-template-columns: repeat(<?php echo $columns; ?>, 1fr); grid-gap: <?php echo $gap; ?>px;"><?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    // Bilder anzeigen
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    $counter = 0;
